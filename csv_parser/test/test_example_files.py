...
def test_parse_csv_1():
    csv_1_path = os.path.join(CSV_FILES_DIR, '1.csv')
    expected = [
    ...
    assert CSVParser(csv_1_path).parse() == expected


def test_parse_csv_2():
    csv_1_path = os.path.join(CSV_FILES_DIR, '2.csv')
    expected = [
...
def test_parse_csv_3():
    csv_1_path = os.path.join(CSV_FILES_DIR, '3.csv')
    expected = [
